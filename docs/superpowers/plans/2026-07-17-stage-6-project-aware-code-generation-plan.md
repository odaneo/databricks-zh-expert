...
3. 校验 `schema_version=1`、ID、SemVer、cloud、Mock 和三个代码 Prompt。
...
按规格提供三个代码 Prompt 的默认来源。概览使用阶段 5 同一项目假设：
...
```powershell
git add src/databricks_zh_expert/prompts src/databricks_zh_expert/artifacts/types.py src/databricks_zh_expert/expert_templates/registry.py src/databricks_zh_expert/devtools/seed_demo_data.py knowledge/expert_templates tests/fixtures/expert_templates tests/unit/test_prompt_registry.py tests/unit/test_prompt_renderer.py tests/unit/test_markdown_artifact.py tests/unit/test_seed_demo_data.py tests/unit/test_expert_template_registry.py tests/unit/test_expert_template_content.py tests/integration/test_prompts_api.py
